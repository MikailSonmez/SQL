...
------------------------------------------------------------------------------*/ 
	...
	add ulke_isim varchar(20) default 'Turkiye';   -- default 'Turkiye' after sehir;  de yapabiliriz
...
-- ORNEK7:  maas kisitlamasi ekle
 ...
 -- Maas alt limit kisitlamasi atadik.
    ...
    INSERT INTO isciler VALUES(123452310, 'Hatice Sahin', 'Bursa', 3500, 'as','as',12);
    -- null'arida doldurup kisitlamayi ilk yaptiginin ustune cikman lazim