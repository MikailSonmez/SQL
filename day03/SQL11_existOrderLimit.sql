...
/* -----------------------------------------------------------------------------
 ...
 from nisan 
 where urun_isim in ( select urun_isim from mart where nisan.urun_isim = mart.urun_isim);
 
  -- 2.yol
 select urun_isim, musteri_isim
 from nisan /* as n */
 where exists ( select urun_isim from mart /* as m*/ where nisan.urun_isim = mart.urun_isim); -- n.urun_isim = m.urun_isim     -- mart as m, nisan as n..... diye yazabilir
...
-- isim 'i NULL olmayanları sorgulayınız.
...
/* ----------------------------------------------------------------------------
 ...
 /* ----------------------------------------------------------------------------
  ORNEK2: kisiler tablosunu maas'e göre ters sıralayarak sorgulayınız.
 -----------------------------------------------------------------------------*/ 
 select * from kisiler
 order by maas desc;
 
/* ----------------------------------------------------------------------------
  ORNEK4: ismi Mine olanları, id'e göre AZALAN sırada sorgulayınız.
-----------------------------------------------------------------------------*/
select * from kisiler
where isim='Mine'
order by id desc;    -- reverse java = desc SQL
...
select * from kisiler limit 10,2;  -- 10dan sonra 2 sayiyi al,
